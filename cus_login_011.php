...
<body class="bg-gradient-success">
    <?php
        ...
        if($request == "POST"){
            ...
            $sql1 = "SELECT clientCompId_011 AS id FROM Client_Credential_011 WHERE clientPassword_011 = ? AND clientUsername_011 = ?";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="Login" method="post" action="cus_login_011.php">
